...
require 'db_charmer/abstract_adapter/connection_name'
require 'db_charmer/active_record/log_subscriber'
...
require 'db_charmer/active_record/relation_method'
require 'db_charmer/active_record/relation/connection_routing'
...
require 'db_charmer/active_record/migration/command_recorder'
ActiveRecord::Migration::CommandRecorder.send(:include, DbCharmer::ActiveRecord::Migration::CommandRecorder)

#---------------------------------------------------------------------------------------------------
# Enable the magic
require 'db_charmer/active_record/master_slave_routing'
...
require 'db_charmer/active_record/preloader/association'
ActiveRecord::Associations::Preloader::Association.send(:include, DbCharmer::ActiveRecord::Preloader::Association)
require 'db_charmer/active_record/preloader/has_and_belongs_to_many'
